import svgPaths from "./svg-5zj76l13hb";

function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[12px] relative shrink-0 w-[343px]">
...
export default function Frame() {
  return (
    <div className="bg-white content-stretch flex gap-[196px] items-start justify-center p-[72px] relative size-full">
      <Frame1 />
      <Frame5 />
    </div>
  );
